    ...
    return (
        <header className="flex justify-between  items-center flex-row  shadow-md  p-1 w-full lg:w-auto rounded-t-md py-2 px-4 bg-[#27272A] text-white ">
            <div className="flex flex-row items-center justify-center gap-2 ">
                ...
                <p className="text-md sm:text-sm font-medium flex flex-wrap flex-col lg:flex-row gap-1">
                    ...
                    <span className="border-animation">
                        <a className="text-blue-500 text-sm duration-1000" target="_blank" href="https://kaushikverma.com/">
            ...
            <div className=" justify-center  lg:flex-row  flex items-center space-x-2 lg:space-x-4">
                <Button variant={'outline'} onClick={onClear} className="cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium transition-all duration-500 outline-none active:scale-95 shadow-xs hover:bg-accent bg-input/30 border-input size-9 lg:size-auto lg:px-3 lg:py-2 text-xs text-white">
                    <Eraser />
                ...
                <div>
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent>
                            <DropdownMenuItem className={'cursor-pointer'} onClick={onLoadJSON}>Import JSON</DropdownMenuItem>
                            <DropdownMenuItem className={'cursor-pointer'} onClick={onRestore}>From LocalStorage</DropdownMenuItem>
                        </DropdownMenuContent>
                    </DropdownMenu>
                </div>
                ...
                <Button variant={'outline'} className="cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium transition-all duration-1000  shrink-0  outline-none active:scale-95 border shadow-xs hover:bg-accent bg-input/30 border-input size-9 lg:size-auto lg:px-3 lg:py-2 text-xs">
                    <ArrowBigUpDash className="w-5 h-5" />
                    <span className="hidden lg:inline-block" onClick={onExport}> Export Json</span>
                </Button>
            </div>
        </header>
    )
